class DCMotor:
    ...
    def __init__(self, pin1, pin2, pin3, pin4, enable_pin1, enable_pin2, min_duty=0, max_duty=65535):
    ...
    def all_motors_forward(self, speed):
        """
    ...
    def motor_1_forward(self, speed):
        """
    ...
    def motor_2_forward(self, speed):
        """
    ...
    def motor_rotation_clockwise(self, speed):
        """
    ...
    def motor_rotation_anticlockwise(self, speed):
        """
